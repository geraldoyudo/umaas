...
=== Getting domains
A 'GET' request will return all domains.
...
A 'GET' request a domain with the specified id.
...
A 'PATCH' request will partially update a specific domain.
...
A 'PUT' request will full update a specific domain. Fields that are not present will be marked as null;
...
=== Removing a Group
A 'DELETE' request will permanently delete a domain from a domain;
...
A 'GET' request will return all user-fields regardless of domain.
...
A 'GET' request will all userFields in a domain.
...
A 'GET' request a userField with the specified id.
...
A 'GET' request will get a specific userField
...
A 'GET' request will a specific user field given a user and field.
...
A 'PATCH' request will partially update a specific userField.
...
A 'PUT' request will full update a specific userField. User Fields that are not present will be marked as null;
...
A 'DELETE' request will remove a userField from a domain. All associations with the userField are also removed.
...
A 'GET' request will return all user-groups regardless of domain.
...
A 'GET' request will all userGroups in a domain.
...
=== Getting User-Groups
A 'GET' request will all user-group relations belonging to a user.
...
A 'GET' request a userGroup with the specified id.
...
A 'GET' request will get a specific userGroup
...
A 'PATCH' request will partially update a specific userGroup.
...
A 'PUT' request will full update a specific userGroup. User Groups that are not present will be marked as null;
...
A 'DELETE' request will remove a userGroup from a domain. All associations with the userGroup are also removed.
...
A 'GET' request will return all Role Mappings regardless of domain.
...
A 'GET' request will all roleMappings in a domain.
...
A 'GET' request will all user-Role relations belonging to a user.
...
A 'GET' request a roleMapping with the specified id.
...
A 'GET' request will get a specific roleMapping
...
A 'PUT' request will full update a specific roleMapping. Role Mappings that are not present will be marked as null;
...
A 'DELETE' request will remove a roleMapping from a domain. All associations with the roleMapping are also removed.
...
=== Getting Role Mappings Across Domains
A 'GET' request will return all user-roles regardless of domain.
...
A 'GET' request a access-code with the specified id.
...
A 'PATCH' request will partially update a specific access-code.
...
A 'PUT' request will full update a specific access-code. Role Mappingss that are not present will be marked as null;
...
A 'DELETE' request will remove a access-code from a domain. All associations with the access-code are also removed.
...
=== Getting Role Mappings Across Domains
A 'GET' request will return all access code mappings.
...
=== Getting A Role Mappings by ID
A 'GET' request a access-code-mapping with the specified id.
...
=== Partially updating a Role Mappings
A 'PATCH' request will partially update a specific access-code-mapping.
...
=== Fully updating a Role Mappings
A 'PUT' request will full update a specific access-code-mapping. Role Mappingss that are not present will be marked as null;
...
A 'DELETE' request will remove a access-code-mapping from a domain. All associations with the access-code-mapping are also removed.
